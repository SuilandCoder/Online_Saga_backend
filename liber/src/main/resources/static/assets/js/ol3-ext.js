 ...
 * @abstract ol3,openlayers,popup,menu,symbol,renderer,interceptor,canvas,interaction,split,statistic,charts,pie,LayerSwitcher,toolbar,animation
 * @version v1.0.1
 ...
 *	- filterLabel {string} label to display in the search bar, default 'interceptor'
 */
...
/** Activate / deactivate interceptor
*	@param {bool}
*/
...
/** Internal function  
* @scoop {ol.interceptor} this the interceptor
* @private
*/
...
/** Force interceptor redraw / Internal function  
* @scoop {ol.map||ol.layer} this: the map or layer the interceptor is added to
* @private
*/
...
/** Add a interceptor to an ol object
* @scoop {ol.map||ol.layer} this: the map or layer the interceptor is added to
* @private
*/
...
/** Remove a interceptor to an ol object
* @scoop {ol.map||ol.layer} this: the map or layer the interceptor is added to
* @private
*/
...
/** Add a interceptor to an ol.Layer
*	@param {ol.filter}
*/
ol.layer.Base.prototype.addFilter = function (filter)
{	addFilter_.call (this, filter);
};
/** Remove a interceptor to an ol.Layer
*	@param {ol.filter}
*/
...
/** Set texture
*	@option {ol.interceptor.TextureOptions}
 ...
 *	- featureFilter {function | undefined} interceptor a function with two arguments, the feature and the layer of the feature. Return true to select the feature 
 *	- layerFilter {function | undefined} interceptor a function with one argument, the layer to test. Return true to test the layer
...
/** Feature interceptor to get only one feature
 ...
 * 	@param {Array<ol.layer.Vector> | undefined} options.layers A list of layers from which polygons should be selected. Alternatively, a interceptor function can be provided. default: all visible layers
 */
 ...
 *	- interceptor {function|undefined} a interceptor that takes a feature and return true if it can be clipped, default always split.
 ...
 *	- interceptor {function|undefined} a interceptor that takes a feature and return true if the feature is eligible for splitting, default always split.
 *	- tolerance {function|undefined} Distance between the calculated intersection and a vertex on the source geometry below which the existing vertex will be used for the split. Default is 1e-10.
...
/** Set RDF query interceptor, default: select language
* @API stable
*/
...
{	// Allways read feature (no interceptor)
	return true;
};
